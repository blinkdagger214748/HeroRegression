...
{
    public class WorldSwordproj2 : ModProjectile
    {
        ...
        {
            Texture2D tex = Request<Texture2D>("HeroRegression/Projectiles/WorldSwordproj").Value;
            ...
            for (int i = 0; i <= 5; i += 1)
            {
                ...
                lightColor = Color.Lerp(Color.Green, Color.DarkSeaGreen, 0.5f) * ((float)(Projectile.oldPos.Length / 2) / (Projectile.oldPos.Length / 2));
