...
namespace HeroRegression.Common.BaseClasses.BaseProj
{
    public abstract class FriendlyProj : ModProjectile
    {
        ...
        public void StaticDefaults(string name, int trailLength = 0, int trailMode = 0)
        {
        ...
        public void Stroke(Color strokeColor, SpriteEffects effect, int num = 8, float radius = 5, float rotSpeed = 6f, float alpha = 1f, float size = 1f)
        {
            ...
            float rot = MathHelper.ToRadians(rotSpeed * HeroRegression.GameTimeNoPause);
            spriteBatch.End();
