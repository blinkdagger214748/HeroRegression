...
namespace HeroRegression.Items.AncientSteel
{
    //文件名
    public class Ancientsteelknife : ModItem
    {
        public override void SetStaticDefaults()
        {
            base.SetStaticDefaults();
            DisplayName.SetDefault("Ancientsteelknife");
            DisplayName.AddTranslation((int)GameCulture.CultureName.Chinese, "神代钢刀");
        }
        ...
        {
            Dust.NewDust(hitbox.TopLeft(), hitbox.Width, hitbox.Height, DustID.Ash, 0, 0, 150, Color.White, 0.8f);
        }
    }
}