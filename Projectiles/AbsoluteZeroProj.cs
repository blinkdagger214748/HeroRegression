    ...
    class AbsoluteZeroProj : ModProjectile
    {
        ...
        public override void AI()
        {
            ...
            else
            {
                ...
                Vector2 projPosition = new Vector2(Projectile.position.X + (float)Projectile.width * 0.5f, Projectile.position.Y + (float)Projectile.height * 0.5f);
                float ToOwnerX = owner.position.X + (float)(owner.width / 2) - projPosition.X;
                float ToOwnerY = owner.position.Y + (float)(owner.height / 2) - projPosition.Y;
